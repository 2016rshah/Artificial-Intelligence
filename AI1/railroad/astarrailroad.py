...
def getNumInput():
    ...
    return result
##    result = ["4800100", "4800445"]
##    #result = ["0100003", "4700400"]
##    #result = ["0100003", "4700118"]
##    #result = ["3500060", "1300287"]
    return result
#--------------------------------------
...
##  f-value (g+h), word, path, g
    ...
    ##create child regardless
                ...
                depth = dist(current[1], word, latlon)+current[3]
